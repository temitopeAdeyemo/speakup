...
class EmailService {
  ...
  async transactionMailFund(
    ...
    type?: { debit?: boolean; credit?: boolean }
  ) {
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                  <tr>
                    <td style="background-color:#ffffff;color:#000000;padding:0 20px;">
                      ...
                      <p>Your account has been Credited <span style="font-weight: bold;">NGN${
                        Number(amount) / 100
                      }</span></p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:0px;">
                        ...
                        <table class="smarttable" width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                          ...
                          <tbody>
                            <tr>
                              <td valign="top" style="padding:5px; display: flex;  align-items: center; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;"><p style="padding: 10px 20px 10px 10px; background-color:#ccdceb; ">A/C Number</p><span style="font-size: 13px; margin-left: 10px;">${account_number?.substring(
                                4,
                                7
                              )}****${account_number?.substring(11)}</span></td>
                              ...
                              <td valign="top" style="padding:5px; display: flex;  align-items: center; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;"><p style="padding: 10px 20px 10px 10px; background-color:#ccdceb; ">Transaction Date</p><span style="font-size: 13px; margin-left: 10px;">${new Date().getDate()}/${
      new Date().getMonth() + 1
    }/${new Date().getFullYear()}
                          </span></td>
                              <td valign="top" style="padding:5px; display: flex;  align-items: center; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;"><p style="padding: 10px 20px 10px 10px; background-color:#ccdceb; ">Transaction Time</p><span style="font-size: 13px; margin-left: 10px;">${
                                new Date().getHours() + 1
                              }:${new Date().getMinutes()}:${new Date().getSeconds()}</span></td>
                              <td valign="top" style="padding:5px; display: flex;  align-items: center; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;"><p style="padding: 10px 20px 10px 10px; background-color:#ccdceb; "> Available Balance</p><span style="font-size: 13px; margin-left: 10px;">${
                                Number(newBalance) / 100
                              }</span></td>
                            </tr>
                          </tbody>
                        </table>
...
Footer`;
    if (type?.debit) {
      ...
      content = `<p>Hi there, Your Account has been debited with ${
        Number(amount) / 100
      } <br/> Amount: ${
        Number(amount) / 100
      } <br/> Payment Number: ${reference_number} <br/> Date: ${new Date().getDate()}/${
        new Date().getMonth() + 1
      }/${new Date().getFullYear()} 
      Time : ${
        new Date().getHours() + 1
      }:${new Date().getMinutes()}:${new Date().getSeconds()}</p>`;
    }
    await this.sendEmail(recipient, subject, content);
  }

  async transactionMailCr(
    recipient: Array<string>,
    receiver_name: string,
    sender_name: string,
    account_number: string | undefined,
                  ...
                  <tr>
                    <td style="padding:0px;">
                        ...
                        <table class="smarttable" width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                          ...
                          <tbody>
                            <tr>
                              <td valign="top" style="padding:5px; display: flex;  align-items: center; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;"><p style="padding: 10px 20px 10px 10px; background-color:#ccdceb; ">Wallet ID</p><span style="font-size: 13px; margin-left: 10px;">${account_number?.substring(
                                4,
                                7
                              )}****${account_number?.substring(11)}</span></td>
                              <td valign="top" style="padding:5px; display: flex;  align-items: center; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;"><p style="padding: 10px 20px 10px 10px; background-color:#ccdceb; ">Account Name</p><span style="font-size: 13px; margin-left: 10px;">${receiver_name}</span></td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                  <tr>
                    <td style="background-color:#ffffff;color:#000000;padding:0 20px;">
                      ...
                      <p>Your account has been Debited <span style="font-weight: bold;">NGN${
                        Number(amount) / 100
                      }</span></p>
                    </td>
                  </tr>
